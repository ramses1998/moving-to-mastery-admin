...
import {MonthlyTransactionListPage} from "./MonthlyTransactionListPage";
import {DetailedTransactionListPage} from "./DetailedTransactionListPage";
                ...
                >
                    ...
                    <Box>
                        <Routes>
                            ...
                            <Route path={"/annual-transactions"} element={<MonthlyTransactionListPage/>}/>
                            <Route path={"/detailed-transactions"} element={<DetailedTransactionListPage/>}/>
                        </Routes>
                    </Box>
                </Box>
