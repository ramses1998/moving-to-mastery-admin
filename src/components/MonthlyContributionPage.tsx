...
import {EditMonthlyContributionModalComponent} from "./common/EditMonthlyContributionModalComponent";
...
export const MonthlyContributionPage: React.FC = () => {
    ...
    }, [mainBankAccount, transactions, fines])
    ...
    return (
        <Box
            ...
            >
                <EditMonthlyContributionModalComponent
